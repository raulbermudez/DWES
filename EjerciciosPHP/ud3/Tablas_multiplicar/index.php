...
<body>
    ...
    <div class="ver_codigo">
        <button type="button"><a href="https://github.com/raulbermudez/DWES/blob/master/EjerciciosPHP/ud3/Tablas_multiplicar/">Ver código</a></button>
    </div>   
</body>
</html>